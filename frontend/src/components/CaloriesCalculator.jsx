    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center">
        <div className="flex items-center justify-center mb-4">
          ...
          <h1 className="text-3xl font-bold text-white">Calorie Calculator</h1>
        </div>
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-purple-600/20 border border-purple-500 rounded-lg p-4">
                    <div className="text-center">
                      <p className="text-purple-300 font-medium mb-1">Daily Calories for {getGoalLabel(calculatedGoal || 'maintain')}</p>
                      <p className="text-3xl font-bold text-white">{calculatedCalories}</p>
                      <p className="text-purple-300">calories per day</p>
                    </div>
                  </div>
